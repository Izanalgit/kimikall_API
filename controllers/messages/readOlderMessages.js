...
module.exports = async (req,res) => {
    ...
    const beforeDate = req.params.lastDate;
    ...
    try {
        ...
        //Read messages
        const messagesRaw = await readMessages(userId, contactId, 10, beforeDate);
        ...
        msgErr.errConsole(userId,'READ OLDER MESSAGES', err);
        return res
            .status(500)
